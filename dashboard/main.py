...
# Menampilkan Jam penyewaan sepeda yang paling banyak dan paling sedikit
    
st.subheader("Jam penyewaan sepeda yang paling banyak dan paling sedikit")
...
with st.expander("Conclusion"):
        st.write('Berdasarkan gambar di atas, Anda dapat melihat bahwa penyewaan sepda paling banyak digunakan pada jam 17:00. Kontras dengan hal tersebut, penyewaan pada jam 04:00 merupakan produk yang paling sedikit terjual.')


# Menampilkan Musim dengan penyewaan sepeda paling banyak
        
st.subheader("Musim dengan penyewaan sepeda paling banyak")
...
with st.expander("Conclusion"):
        st.write('Musim yang paling banyak disewa adalah pada musim Fall dengan total penyewaan sebanyak 1061129 penyewaan.')


# Menampilkan Performa penjualan perusahaan dalam beberapa tahun terakhir
...
with st.expander("Conclusion"):
        st.write('Berdasarkan visualisasi di atas, kita dapat melihat bahwa jumlah order terbanyak terjadi pada bulan September 2012. Selain itu, kita juga dapat melihat adanya penurunan jumlah order yang cukup signifikan pada bulan januari 2011.')
